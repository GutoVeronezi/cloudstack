...
public class KVMHAMonitor extends KVMHABase implements Runnable {
    ...
    public KVMHAMonitor(NfsStoragePool pool, String host, String scriptPath) {
        ...
        rebootHostAndAlertManagementOnHearbeatTimeout = AgentPropertiesFileHandler.getProperty(AgentProperties.REBOOT_HOST_AND_ALERT_MANAGEMENT_ON_HEARBEAT_TIMEOUT);
    }
